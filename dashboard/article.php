...
// ob_start();
// session_start();
$page_title = "Articles & Researches | Onyeka Nwelue TV";
...
// }
 ?>					
		...
		<center><h3>Articles & Researches</h3></center>
		<?php 
			$sql = "SELECT * FROM posts WHERE cat_id = 3 ORDER BY post_date DESC LIMIT 100";
